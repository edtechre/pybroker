...
Use [ctx.foreign](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.foreign) and pass a symbol to [ctx.indicator](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.indicator):
...
Use [positions](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.positions), [long_positions](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.long_positions), [short_positions](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.short_positions), [long_pos](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.long_pos), and [short_pos](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.short_pos). To check whether any long or short positions are open without materializing them, use [has_long_positions](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.has_long_positions) and [has_short_positions](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.has_short_positions):
...
Use the [ctx.session](https://www.pybroker.com/en/latest/reference/pybroker.context.html#pybroker.context.ExecContext.session) dictionary:
...
Use [param](https://www.pybroker.com/en/latest/reference/pybroker.scope.html#pybroker.scope.param) for global values shared across a session. For tunable strategy parameters used with [optimize](https://www.pybroker.com/en/latest/reference/pybroker.strategy.html#pybroker.strategy.Strategy.optimize), use [hyperparam](https://www.pybroker.com/en/latest/reference/pybroker.optimize.html#pybroker.optimize.hyperparam) instead:
...
### Record position bars

Set [record_position_bars](https://www.pybroker.com/en/latest/reference/pybroker.config.html#pybroker.config.StrategyConfig.record_position_bars) to capture per-bar position snapshots in [result.positions](https://www.pybroker.com/en/latest/reference/pybroker.strategy.html#pybroker.strategy.TestResult.positions):
