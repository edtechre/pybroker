...
We liquidate the currently held stock if it is no longer ranked among the top five 20-day ROCs. Otherwise, we rank all stocks by their 20-day ROC and buy up to the top two ranked. For more information on ranking when placing buy orders, see the [Ranking Buy and Short Signals notebook](https://www.pybroker.com/en/latest/notebooks/4.%20Ranking%20Buy%20and%20Short%20Signals.html).
