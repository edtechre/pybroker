...
- Fast backtesting engine built with [NumPy](https://numpy.org/) and [Numba](https://numba.pydata.org/) acceleration.
...
- Includes robust metrics calculated with randomized [bootstrapping](https://en.wikipedia.org/wiki/Bootstrapping_(statistics)).
