...
class WindowOptimizeResult:
    ...
    Attributes:
        ...
        study: :class:`optuna.study.Study` holding this window's trials.
...
class OptimizeResult:
    ...
    Attributes:
        ...
        result: :class:`pybroker.strategy.TestResult` for the test window. When
            ...
            window boundaries.
        study: :class:`optuna.study.Study` holding the trials. When ``windows`` is set,
    ...
    def optimize(
        ...
        *,
        ...
        Args:
            ...
            study: Existing :class:`optuna.study.Study` to record trials in, for
        ...
        Raises:
            ValueError: If no executions were added, if any model source is
                ...
                direction, or if the dates fall outside the range passed to the
                :class:`pybroker.strategy.Strategy` constructor.
        """
