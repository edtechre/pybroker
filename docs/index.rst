...
.. raw:: html
   ...
   <embed>
      ...
      <a href="https://pypi.org/project/lib-pybroker/">
         <img src="https://img.shields.io/badge/pypi-v1.0.10-brightgreen.svg"
            alt="PyPI">
      </a> &nbsp;
...
* Includes robust metrics calculated with randomized `bootstrapping <https://en.wikipedia.org/wiki/Bootstrapping_(statistics)>`_.
