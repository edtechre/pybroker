...
.. raw:: html
   ...
   <embed>
      ...
      <a href="https://pypi.org/project/lib-pybroker/">
         <img src="https://img.shields.io/badge/pypi-v1.0.16-brightgreen.svg"
            alt="PyPI">
      </a> &nbsp;
...
* Better evaluation metrics calculated from randomized `bootstrapping <https://en.wikipedia.org/wiki/Bootstrapping_(statistics)>`_.
